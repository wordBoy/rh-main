<?php
    ...
    /**
     * Contact Us submit mail functionality.
     */
    ...
    //Wrangle form submit values
        ...
        if ( isset( $_POST['howCanWeHelp'] ) ) {
            $contactMsg = $_POST['howCanWeHelp'];
            $contactMsg = htmlspecialchars( $contactMsg );
        }
        if ( !isset($contactMsg) ) $contactMsg = "(No valid value found)";
    ...
    //Manage validation
        ...
        $contactFullContent .= "Contact Form Msg\n";
        $contactFullContent .= "Date: $dateStr \n";
        $contactFullContent .= "First name: $firstName \n";
        $contactFullContent .= "Last name: $lastName \n";
        $contactFullContent .= "Email: $emailAddress \n";
        $contactFullContent .= "Phone: $phoneNum \n";
        $contactFullContent .= "Message: $contactMsg \n";

    //Send email with contact us information
        ...
        $email_subject = "Contact Request From Raymeshelp.org" ;
        $email_body = $contactFullContent;
