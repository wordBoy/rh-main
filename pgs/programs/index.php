...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Rayme's Hope Community Programs" />
    <title>Community Programs | Rayme's Hope</title>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
            <div class="col my-2">
              ...
              <p>Placeholder Content. There are three programs to which the user can link:</p>
              <ul>
                <li><a href="programs-food.php">Food</a></li>
                <li><a href="programs-care.php">Urgent and Ongoing Care</a></li>
